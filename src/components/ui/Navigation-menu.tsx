...
>(({ className, ...props }, ref) => (
  <div className={classMerge('absolute left-0 top-full flex justify-center')}>
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={classMerge('relative z-10 flex flex-1 items-center justify-center', className)}
    {...props}
  >
    {children}
